...
$(function() {
 ...
 $("#iconCon-colors").spectrum({
    ...
    hide: function (color) {
        changeIconConColor(color.toHexString())      
    },
...
$("#background-colors").spectrum({
    ...
    hide: function (color) {   
       changeIconColor(color.toHexString()) 
    },
...
$("#text-colors").spectrum({
    ...
    hide: function (color) {
        changeIconFontColor(color.toHexString()) 
    },
...
//边框的颜色
    $("#border-colors").spectrum({
    allowEmpty:true,
    color: "#000",
    showInput: true,
    containerClassName: "full-spectrums",
    showInitial: true,
    showPalette: true,
    showSelectionPalette: true,
    showAlpha: true,
    ...
    hide: function (color) {
        changeIconBorderColor(color.toHexString()) 
    },
